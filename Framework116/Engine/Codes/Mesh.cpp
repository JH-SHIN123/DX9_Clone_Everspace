...
CMesh::CMesh(LPDIRECT3DDEVICE9 pDevice, const TCHAR* pFilePath, const TCHAR* pTexturePath) :
	CComponent(pDevice),
...
CMesh* CMesh::Create(LPDIRECT3DDEVICE9 pDevice, const TCHAR* pFilePath, const TCHAR* pTexturePath)
{
	CMesh* pInstance = new CMesh(pDevice, pFilePath, pTexturePath);
